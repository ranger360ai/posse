...
// table, transcriptFiles is the locator (<config dir>/projects/*/*.jsonl),
// and ScanTranscript is the record decoder. The method is unchanged and stays
...
func (claudeCost) Reads() string {
	return "transcript scanner (~/.claude/projects/*.jsonl, or $CLAUDE_CONFIG_DIR's, ADR 0003 §4)"
}
