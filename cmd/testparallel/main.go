...
func main() {
	...
	parallelOK := map[string]string{
		...
		"TestQAPlan429BackoffCredentialRefreshClearsTheCooldown":     "reads blindT",
		"TestQAPlan429BackoffCredentialRefreshRestartsTheEscalation": "reads blindT",
		...
		"TestQAPlan429BackoffUnchangedCredentialStillCoolsDown":      "reads blindT",
